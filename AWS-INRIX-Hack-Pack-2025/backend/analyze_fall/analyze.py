...
class EmergencyImageAnalyzer:
    ...
    def analyze_fall_image(
        ...
        prompt = self._create_medical_prompt(
            severity, velocity, angle, torso_tilt, head_drop, stillness
        )

        return self._analyze_with_gemini(image_base64, prompt)

    def _create_medical_prompt(
        self, severity, velocity, angle, torso_tilt=None, head_drop=None, stillness=None
    ):
