  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-600">Dual AI-powered fall detection with AWS integration</p>
      </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-slate-500">MediaPipe on-device detection</p>
              </div>
...
function MetricsPanel({ features }: { features: FallFeatures }) {
  return (
    <div className="grid gap-3 md:grid-cols-2">
      <MetricCard label="Torso tilt" value={`${features.torsoTiltDeg.toFixed(0)}°`} tone="amber" />
